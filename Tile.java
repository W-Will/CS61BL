...
public class Tile {
    ...
    /** Return the mergeMarker. */
    public boolean getMarker() { return mergeMarker;}

    /** set the mergeMarker to a boolean value. */
    public void setMarker(boolean b) { mergeMarker = b;}
